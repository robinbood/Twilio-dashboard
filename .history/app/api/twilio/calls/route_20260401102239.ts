...
// API route handler for fetching Twilio calls
export async function GET(request: NextRequest) {
  try {
    ...
    const voipNumbersParam = searchParams.get('voipNumbers');
    const voipNumbers = voipNumbersParam ? voipNumbersParam.split(',') : undefined;
